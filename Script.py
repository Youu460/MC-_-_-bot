...
𝙼𝚈 𝙽𝙰𝙼𝙴 𝙸𝚂 <a href=https://t.me/{}>{}</a>, ⁱᵃᵐ ᵃᵘᵗᵒ ᶠⁱˡᵗᵉʳ ᵇᵒᵗ ʰᵉʳᵉ ʸᵒᵘ ᶜᵃⁿ ʳᵉᵠᵘᵉˢᵗ ᵐᵒᵛⁱᵉ'ˢ, ʲᵘˢᵗ ˢᵉⁿᵗ ᵐᵒᵛⁱᵉ ⁿᵃᵐᵉ ʷⁱᵗʰ ᵖʳᵒᵖᵉʳ ᵍᵒᵒᵍˡᵉ ˢᵖᵉˡˡⁱⁿᵍ..!!"""
    HELP_TXT = """
     Hey  {} 
...
<blockquote>🔻 Tᴀᴘ ᴏɴ ᴛʜᴇ ꜰɪʟᴇ ʙᴜᴛᴛᴏɴ ᴀɴᴅ ᴛʜᴇɴ ꜱᴛᴀʀᴛ ᴛᴏ ᴅᴏᴡɴʟᴏᴀᴅ 🔻
⚠️ᵃᶠᵗᵉʳ 5 ᵐⁱⁿᵘᵗᵉˢ ᵐᵉˢˢᵃᵍᵉ ʷⁱˡˡ ᵇᵉ ᵃᵘᵗᵒᵐᵃᵗⁱᶜᵃˡˡʸ ᵈᵉˡᵉᵗᵉᵈ 🗑</blockquote>"""
